                ...
                <Box sx={{ mb: 5 }}>
                    <Box sx={{ ml: 7, my: 4 }}>
                        ...
                        <Typography variant="h7" gutterBottom component="div" sx={{ mt: 2 }}>
                            Map given below represents air quality of Kolkata on four parameters:
                        ...
                        <Box p={3}>
                            ...
                            <Box mt={2}>
                                {/* <Typography gutterBottom variant="h6">
                                    <span style={{ marginLeft: "300px" }}>INDIA</span><span style={{ marginLeft: "620px" }}>West Bengal</span>
                                </Typography> */}
                            </Box>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={6}>
                                    <Card elevation={3}>
                                        <iframe width="740" height="460" frameborder="0" title="4" src="https://www.globalforestwatch.org/embed/widget/emissionsDeforestation/country/IND/36"></iframe>
                                    </Card>
                                </Grid>
                                {/* <Grid item xs={6}>
                                    <Card elevation={3}>
                                ...
                                <Grid item xs={6}>
                                    <Card elevation={3}>
                                        <iframe width="740" height="460" frameborder="0" title="6" src="https://www.globalforestwatch.org/embed/widget/emissionsDeforestationDrivers/country/IND/36?emissionsDeforestationDrivers=eyJoaWdobGlnaHRlZCI6ZmFsc2V9"></iframe>
                                    </Card>
                                </Grid>
                                {/* <Grid item xs={6}>
                                    <Card elevation={3}>
                                ...
                                <Grid item xs={6}>
                                    <Card elevation={3}>
                                        <iframe width="740" height="660" frameborder="0" title="2" src="https://www.globalforestwatch.org/embed/widget/carbonFlux/country/IND/36"></iframe>
                                    </Card>
                                </Grid>
                            </Grid>
                        </Box>
