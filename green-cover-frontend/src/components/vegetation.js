                ...
                <Box sx={{ mb: 5 }}>
                    <Box sx={{ ml: 7, my: 4 }}>
                        ...
                        <Typography variant="body2" gutterBottom sx={{ mt: 2, maxWidth: "80%" }}>
                            ...
                            <strong>NDVI = </strong>(Band 8 - Band 4) / (Band 8 + Band 4) <br />
                            <strong>EVI = </strong>2.5 * ((Band 8 - Band 4) / (Band 8 + 6 * Band 4 - 7.5 * Band 2 + 1))
                        </Typography>
                    </Box>
                    <MapFrame url={data.map_url} height={"740"}/>
                    <Box sx={{ pt:2, ml: 7, my: 8 }}>
                        <Typography variant="h5" gutterBottom component="div">
                            Time series graphical analysis representing Vegetation Indexes (NDVI and EVI) of 
                        </Typography>
                        <Typography variant="h7" gutterBottom component="div">
                            Dataset Used:{" "}
