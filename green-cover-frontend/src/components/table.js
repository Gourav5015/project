...
const rows = [
    createData('Estimating Green Cover using Vegetation Indexes (Global) ', 'Harmonized Sentinel-2 MSI: MultiSpectral Instrument, Level-2A '),
    createData('Timelapse for Normalized Difference Vegetation Index (NDVI) (Global)', 'Harmonized Sentinel-2 MSI: MultiSpectral Instrument, Level-2A '),
    createData('Time series graphical analysis representing Vegetation Indexes (NDVI & EVI) of Kolkata', 'MOD13Q1.006 Terra Vegetation Indices 16-Day Global 250m '),
